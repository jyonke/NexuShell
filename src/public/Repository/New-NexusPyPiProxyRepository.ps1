function New-NexusPyPiProxyRepository {
    <#
.SYNOPSIS
...
New-NexusPyPiProxyRepository @ProxyParameters
...
New-NexusPyPiProxyRepository @ProxyParameters
#>
    [CmdletBinding(HelpUri = 'https://nexushell.dev/New-NexusPyPiProxyRepository/', DefaultParameterSetname = "Default")]
    Param(
        [Parameter(Mandatory)]
        [String]
        $Name,
    ...
    begin {
        ...
        $urislug = "/service/rest/v1/repositories/pypi/proxy"
