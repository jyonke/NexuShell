function New-NexusRubyGemsProxyRepository {
    <#
.SYNOPSIS
...
New-NexusRubyGemsProxyRepository @ProxyParameters
...
New-NexusRubyGemsProxyRepository @ProxyParameters
#>
    [CmdletBinding(HelpUri = 'https://nexushell.dev/New-NexusRubyGemsProxyRepository/', DefaultParameterSetname = "Default")]
    Param(
        [Parameter(Mandatory)]
        [String]
        $Name,
...
[Parameter()]
    ...
    begin {
        ...
        $urislug = "/service/rest/v1/repositories/rubygems/proxy"
