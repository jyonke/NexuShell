function New-NexusNPMProxyRepository {
    <#
.SYNOPSIS
...
New-NexusNPMProxyRepository @ProxyParameters
...
New-NexusNPMProxyRepository @ProxyParameters
#>
    [CmdletBinding(HelpUri = 'https://nexushell.dev/New-NexusNPMProxyRepository/', DefaultParameterSetname = "Default")]
    Param(
        [Parameter(Mandatory)]
        [String]
        $Name,
    ...
    begin {
        ...
        $urislug = "/service/rest/v1/repositories/npm/proxy"
