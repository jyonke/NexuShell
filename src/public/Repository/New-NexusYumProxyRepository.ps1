function New-NexusYumProxyRepository {
    <#
.SYNOPSIS
...
New-NexusYumProxyRepository @ProxyParameters
#>
    [CmdletBinding(HelpUri = 'https://nexushell.dev/New-NexusYumProxyRepository/', DefaultParameterSetname = "Default")]
    Param(
        [Parameter(Mandatory)]
        [String]
        $Name,
...
[Parameter()]
    ...
    begin {
        ...
        $urislug = "/service/rest/v1/repositories/yum/proxy"
