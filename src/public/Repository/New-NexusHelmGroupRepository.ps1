function New-NexusHelmGroupRepository {
    <#
    .SYNOPSIS
    Creates a Helm Group repository
    ...
    The Helm Repositories to add as group members
    ...
    .EXAMPLE
    New-NexusHelmGroupRepository -Name Helm-group -GroupMembers Helm-releases,Helm-central -
    
    .NOTES
    #>
    [CmdletBinding(HelpUri = 'https://nexushell.dev/New-NexusHelmGroupRepository/')]
    Param(
        [Parameter(Mandatory)]
        [String]
        $Name,
    ...
    begin {
        ...
        $urislug = "/service/rest/v1/repositories/helm/group"
