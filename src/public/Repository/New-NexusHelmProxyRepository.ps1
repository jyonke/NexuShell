function New-NexusHelmProxyRepository {
    <#
.SYNOPSIS
...
New-NexusHelmProxyRepository @ProxyParameters
...
New-NexusHelmProxyRepository @ProxyParameters
#>
    [CmdletBinding(HelpUri = 'https://nexushell.dev/New-NexusHelmProxyRepository/', DefaultParameterSetname = "Default")]
    Param(
        [Parameter(Mandatory)]
        [String]
        $Name,
    ...
    begin {
        ...
        $urislug = "/service/rest/v1/repositories/helm/proxy"
